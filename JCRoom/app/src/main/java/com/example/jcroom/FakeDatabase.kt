...
fun getInsectPreview() = Insect(1, "Alan",
...
fun getAllInsectsPreview() = listOf(getInsectPreview(),getInsectPreview(),getInsectPreview(),getInsectPreview(),getInsectPreview(),)

const val UID_FAKE = 1_000_000L
fun getAllInsectsDefault() = listOf(
    Insect(0, "Hormiga León",
        "https://www.ecured.cu/images/8/8a/Hormiga-leon-larva.jpg",
        false, UID_FAKE),
    Insect(0, "Libélula",
        "https://keken.com.mx/wp-content/uploads/2023/10/el-ciclo-de-vida-de-las-libelulas-y-su-infuencia-en-la-biodiversidad-Rayadora-de-Bandas-Negras-por-keken.jpg",
        false, UID_FAKE),
    Insect(0, "Alacrán",
        "https://www.gaceta.unam.mx/wp-content/uploads/2019/10/190930-aca3-des-f1-escorpion.jpg",
        false, UID_FAKE),
    Insect(0, "Tijereta",
        "https://live.staticflickr.com/2156/1875240197_4edc9b983d_z.jpg",
        false, UID_FAKE),
    Insect(0, "Abeja",
        "https://mielsierraflor.es/wp-content/uploads/2024/12/caracteristicas-de-las-abejas.jpg",
        false, UID_FAKE),
    Insect(0, "Cochinilla",
        "https://inaturalist-open-data.s3.amazonaws.com/photos/18382638/large.jpg",
        false, UID_FAKE),
    Insect(0, "Catarina",
        "https://media.istockphoto.com/id/893470324/es/foto/mariquita-en-la-verde-hierba.jpg?s=612x612&w=0&k=20&c=9BSFwYZhyuLtpYvjL4cXBebkZIxREMIos0vFVFfsV24=",
        false, UID_FAKE),
    Insect(0, "Escarabajo",
        "https://pictureinsect.com/image-handle/image/1080/152440389515608068.jpeg?x-oss-process=image/format,webp/resize,s_343&v=1.0",
        false, UID_FAKE),
    Insect(0, "Mantis",
        "https://cultivodelgranado.es/wp-content/uploads/2021/05/mantis-religiosa_0.jpg",
        false, UID_FAKE),
    Insect(0, "Oruga",
        "https://cdn0.uncomo.com/es/posts/2/0/2/como_eliminar_orugas_de_forma_natural_44202_600.jpg",
        false, UID_FAKE),
    Insect(0, "Saltamontes",
        "https://www.tiendanimal.es/articulos/wp-content/uploads/2020/03/saltamontes-1200x900.jpg",
        false, UID_FAKE)
)

fun getInsectsInDanger() = listOf(
    Insect(0, "Libélula",
        "https://keken.com.mx/wp-content/uploads/2023/10/el-ciclo-de-vida-de-las-libelulas-y-su-infuencia-en-la-biodiversidad-Rayadora-de-Bandas-Negras-por-keken.jpg",
        false, UID_FAKE),
    Insect(0, "Mantis", //incomplete name fot test LIKE query
        "https://cultivodelgranado.es/wp-content/uploads/2021/05/mantis-religiosa_0.jpg",
        false, UID_FAKE)
)