...
import com.example.xmlintents.MainActivity
...
class LaunchIntent(private val context: Context) {
    ...
    private fun startIntent(intent: Intent){
        val chooser: Intent = Intent.createChooser(intent, "Hola mundi")
    ...
    fun addContact(){
        ...
        intent.apply {
            ...
            putExtra(ContactsContract.Intents.Insert.PHONE, "+526598444")
        }
        startIntent(intent)
    }
    fun dialPhone(){
    ...
    fun sendEmail(){
        ...
        intent.apply {
            data = "mailto:".toUri()
            putExtra(Intent.EXTRA_EMAIL, arrayOf("Chris@mail.zoo"))
    ...
    fun sendSms(){
        Log.i("Cryz", "sendSms")
        val smsUri = "smsto:477893541".toUri()
